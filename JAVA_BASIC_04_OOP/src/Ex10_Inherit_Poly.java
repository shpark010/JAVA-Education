...
JAVA : [상속관계]에서 하나의 참조변수가 [여러개의 타입]을 가질 수 있는 것
>> [하나의 참조변수] >> 부모타입
>> [여러개의 타입] >> 부모를 상속받은 자식 타입

다형성 : 현실 >> 부모는 자식에게 모든 것을 준다.
	   프로그램 >> 자식이 부모에게 조건없이 모든 것을 준다.
*/
...
public class Ex10_Inherit_Poly {
	...
	public static void main(String[] args) {
		...
		System.out.println(tv2.toString());	//CapTv@515f550a	자신이 가지는 타입정보(부모)
		System.out.println(ct.toString());	//CapTv@515f550aCapTv@515f550a
		//tv2.cpationText();
